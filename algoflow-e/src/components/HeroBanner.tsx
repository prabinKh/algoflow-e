    ...
    <div className="relative overflow-hidden rounded-[var(--radius-outer)] bg-gradient-to-br from-foreground via-foreground to-primary/20 text-background min-h-[400px] sm:min-h-[450px] lg:min-h-[500px] flex items-center">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8 sm:gap-10 p-6 sm:p-10 lg:p-16 w-full">
        <div className="flex-1 space-y-5 sm:space-y-7 text-center lg:text-left">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tighter leading-[1.1]">
            ...
            {[
              ...
              <div key={i} className={`${spec.showClass || "flex"} items-center gap-3`}>
                <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl bg-primary/20 flex items-center justify-center border border-primary/20">
                  <spec.icon size={18} className="text-primary-foreground sm:w-5 sm:h-5" />
                </div>
